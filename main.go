...
func main() {
	...
	r.GET("/Provinces", userHandler.IndexProvinces)
	r.GET("/Regencies", userHandler.IndexRegencies)
	r.GET("/Districts", userHandler.IndexDistricts)
	r.GET("/Villages", userHandler.IndexVillages)
